...
public class GameRendererHook extends GameRenderer {
    ...
    public GameRendererHook(Minecraft p_i225966_1_, IResourceManager p_i225966_2_, RenderTypeBuffers p_i225966_3_) {
        ...
        this.itemInHandRenderer = new FirstPersonRendererHook();
    ...
    private void bobHurt(MatrixStack p_228380_1_, float p_228380_2_) {
        if (this.noHurtCam.getState()) return;
        ...
        if (!this.minecraft.noRender) {
            ...
            if (this.minecraft.overlay != null) {
                ...
                try {
                    ...
                    CrashReport crashreport1 = CrashReport.forThrowable(throwable, "Rendering gui");
    ...
    private void takeAutoScreenshot() {
        if (this.minecraft.levelRenderer.hasRenderedAllChunks() && !this.minecraft.getSingleplayerServer().hasWorldScreenshot()) {
    ...
    public void renderLevel(float p_228378_1_, long p_228378_2_, MatrixStack p_228378_4_) {
        ...
        activerenderinfo.setup(this.minecraft.level, (this.minecraft.getCameraEntity() == null ? this.minecraft.player : this.minecraft.getCameraEntity()), !this.minecraft.options.getCameraType().isFirstPerson(), this.minecraft.options.getCameraType().isMirrored(), p_228378_1_);
        ...
        RenderWorldEvent event = new RenderWorldEvent(p_228378_4_, p_228378_1_, activerenderinfo);
