...
@OnlyIn(Dist.CLIENT)
public class MainMenuHook extends Screen {
    ...
    public MainMenuHook(boolean p_i51107_1_) {
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        ...
        if ((l & -67108864) != 0) {
            ...
            drawString(p_230430_1_, this.font, "Minecraft 1.16.5/modified (Modded)", 0, this.height - 10, 16777215 | l);
