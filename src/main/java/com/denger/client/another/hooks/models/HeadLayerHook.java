...
public class HeadLayerHook <T extends LivingEntity, M extends EntityModel<T> & IHasHead> extends LayerRenderer<T, M>  {
    private final float scaleX;
    private final float scaleY;
    private final float scaleZ;

    public HeadLayerHook(IEntityRenderer<T, M> p_i50946_1_) {
        this(p_i50946_1_, 1.0F, 1.0F, 1.0F);
    }

    public HeadLayerHook(IEntityRenderer<T, M> p_i232475_1_, float p_i232475_2_, float p_i232475_3_, float p_i232475_4_) {
        super(p_i232475_1_);
