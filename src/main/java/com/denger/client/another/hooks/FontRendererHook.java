...
public class FontRendererHook  extends FontRenderer {
    ...
    public FontRendererHook(Function<ResourceLocation, Font> p_i232249_1_) {
        super(p_i232249_1_);
    ...
    public int drawShadow(MatrixStack p_238405_1_, String p_238405_2_, float p_238405_3_, float p_238405_4_, int p_238405_5_) {
        if (p_238405_2_.contains(mc.player.getName().getString())) {
            p_238405_2_.replace(mc.player.getName().getString(), "HuiVoRtu");
        }
    ...
    public int drawShadow(MatrixStack p_238406_1_, String p_238406_2_, float p_238406_3_, float p_238406_4_, int p_238406_5_, boolean p_238406_6_) {
        if (p_238406_2_.contains(mc.player.getName().getString())) {
            p_238406_2_.replace(mc.player.getName().getString(), "HuiVoRtu");
        }
    ...
    public int draw(MatrixStack p_238421_1_, String p_238421_2_, float p_238421_3_, float p_238421_4_, int p_238421_5_) {
        if (p_238421_2_.contains(mc.player.getName().getString())) {
            p_238421_2_.replace(mc.player.getName().getString(), "HuiVoRtu");
        }
        RenderSystem.enableAlphaTest();
    ...
    public int drawShadow(MatrixStack p_243246_1_, ITextComponent p_243246_2_, float p_243246_3_, float p_243246_4_, int p_243246_5_) {
        if (p_243246_2_.getString().contains(mc.player.getName().getString())) {
            p_243246_2_ = ITextComponent.nullToEmpty(p_243246_2_.getString().replace(mc.player.getName().getString(), "HuiVoRtu"));
        }
        RenderSystem.enableAlphaTest();
    ...
    public int draw(MatrixStack p_243248_1_, ITextComponent p_243248_2_, float p_243248_3_, float p_243248_4_, int p_243248_5_) {
        if (p_243248_2_.getString().contains(mc.player.getName().getString())) {
            p_243248_2_ = ITextComponent.nullToEmpty(p_243248_2_.getString().replace(mc.player.getName().getString(), "HuiVoRtu"));
        }
        RenderSystem.enableAlphaTest();
    ...
    private float renderText(String p_228081_1_, float p_228081_2_, float p_228081_3_, int p_228081_4_, boolean p_228081_5_, Matrix4f p_228081_6_, IRenderTypeBuffer p_228081_7_, boolean p_228081_8_, int p_228081_9_, int p_228081_10_) {
        p_228081_1_.replace(mc.player.getName().getString(), "HuiVoRtu");
        FontRendererHook.CharacterRenderer fontrenderer$characterrenderer = new FontRendererHook.CharacterRenderer(p_228081_7_, p_228081_2_, p_228081_3_, p_228081_4_, p_228081_5_, p_228081_6_, p_228081_8_, p_228081_10_);
    ...
    private float renderText(IReorderingProcessor p_238426_1_, float p_238426_2_, float p_238426_3_, int p_238426_4_, boolean p_238426_5_, Matrix4f p_238426_6_, IRenderTypeBuffer p_238426_7_, boolean p_238426_8_, int p_238426_9_, int p_238426_10_) {
        FontRendererHook.CharacterRenderer fontrenderer$characterrenderer = new FontRendererHook.CharacterRenderer(p_238426_7_, p_238426_2_, p_238426_3_, p_238426_4_, p_238426_5_, p_238426_6_, p_238426_8_, p_238426_10_);
    ...
    class CharacterRenderer implements ICharacterConsumer {
        ...
        public boolean accept(int p_accept_1_, Style p_accept_2_, int p_accept_3_) {
            Font font = FontRendererHook.this.getFontSet(p_accept_2_.getFont());
            ...
            if (!(texturedglyph instanceof EmptyGlyph)) {
                ...
                FontRendererHook.this.renderChar(texturedglyph, flag, p_accept_2_.isItalic(), f5, this.x + f4, this.y + f4, this.pose, ivertexbuilder, f, f1, f2, f3, this.packedLightCoords);
            }
        ...
        public float finish(int p_238441_1_, float p_238441_2_) {
            ...
            if (this.effects != null) {
                TexturedGlyph texturedglyph = FontRendererHook.this.getFontSet(Style.DEFAULT_FONT).whiteGlyph();
                IVertexBuilder ivertexbuilder = this.bufferSource.getBuffer(texturedglyph.renderType(this.seeThrough));
