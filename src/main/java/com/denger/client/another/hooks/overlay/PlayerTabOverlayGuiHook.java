package com.denger.client.another.hooks.overlay;
...
public class PlayerTabOverlayGuiHook extends PlayerTabOverlayGui {
    private static final Ordering<NetworkPlayerInfo> PLAYER_ORDERING = Ordering.from(new PlayerTabOverlayGuiHook.PlayerComparator());
    ...
    public PlayerTabOverlayGuiHook(Minecraft p_i45529_1_, IngameGui p_i45529_2_) {
        super(p_i45529_1_, p_i45529_2_);
        this.minecraft = p_i45529_1_;
        this.gui = p_i45529_2_;
    }

    public ITextComponent getNameForDisplay(NetworkPlayerInfo p_200262_1_) {
        ITextComponent v = p_200262_1_.getTabListDisplayName() != null ? this.decorateName(p_200262_1_, p_200262_1_.getTabListDisplayName().copy()) : this.decorateName(p_200262_1_, ScorePlayerTeam.formatNameForTeam(p_200262_1_.getTeam(), new StringTextComponent(p_200262_1_.getProfile().getName())));
        assert mc.player != null;
        if (v.getString().contains(mc.player.getName().getString())) return ITextComponent.nullToEmpty("HuiVoRtu");
        return v;
    }
        ...
        for (int i5 = 0; i5 < i4; ++i5) {
            ...
            if (i5 < list.size()) {
                ...
                if (p_238523_4_ != null && networkplayerinfo1.getGameMode() != GameType.SPECTATOR) {
                    ...
                    int i6 = l5 + l;
                    if (i6 - l5 > 5) {
                        if (gameprofile.getName().contains(mc.player.getName().getString())){
                            this.renderTablistScore(p_238523_4_, l2, "HuiVoRtu", l5, i6, networkplayerinfo1, p_238523_1_);
